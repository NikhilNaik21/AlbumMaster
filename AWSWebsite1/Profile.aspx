    ...
    <section class="profile-section">
        <div class="container py-5 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-xl-10 mb-4 mb-lg-0">
                    ...
                    <div class="profile-card-wrap">
                        <div class="row g-0">
                            ...
                            <!-- LEFT: Gradient Panel -->
                            <div class="col-md-4 gradient-custom text-center text-white profile-left-panel">
                                <a id="lnkProfilePic" title="Upload Profile Picture" style="cursor:pointer;">
                                    <div class="profile-avatar">
                                        <img src="<%= profileImage %>" id="imgProfile" alt="Profile" style="max-width: 207px;margin-top: 32px;"/>
                            ...
                            <div class="col-md-8 profile-right-panel">
                ...
                var mediaUploader = new plupload.Uploader({
                    ...
                    init: {
                        ...
                        FileUploaded: function (up, file, response) {
                            ...
                            if (data.IsSuccess) {
                                $("#imgProfile").attr("src", data.Message + "?t=" + new Date().getTime());
